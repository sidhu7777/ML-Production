...
from tools.New_pdf_report.routes import new_pdf_report_bp
...
def create_app(config_name='default'):
    ...
    app.register_blueprint(new_pdf_report_bp, url_prefix='/api/new-pdf-report')
    ...
    def root():
        return jsonify({
            ...
            "services": {
                ...
                "report": "/api/report",
                "new_pdf_report": "/api/new-pdf-report",
