...
from tools.coverage_prediction.future_demand_capacity_forecast.schema import CREATE_TABLE_SQL, EXPECTED_COLUMNS, TABLE_NAME
...
def create_model2_results_table(region: str = "india") -> list[str]:
...
def main() -> None:
    region = os.getenv("MODEL2_SCHEMA_REGION", "india")
    columns = create_model2_results_table(region)
