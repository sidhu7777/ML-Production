...
TABLE_NAME = "lte_future_demand_capacity_forecast_results"
...
CREATE TABLE IF NOT EXISTS {TABLE_NAME} (
    ...
    model_name VARCHAR(100) NOT NULL DEFAULT 'future_demand_capacity_forecast',
    ...
    PRIMARY KEY (id),
    UNIQUE KEY uq_future_demand_capacity_project_baseline_run_cell (
        project_id,
        baseline_job_id,
        model_run_id,
        node_cell_id,
    ...
    KEY idx_future_demand_capacity_project_id (project_id),
    KEY idx_future_demand_capacity_project_baseline (project_id, baseline_job_id),
    KEY idx_future_demand_capacity_model_run_id (model_run_id),
    KEY idx_future_demand_capacity_cell (site_id, sector_id, node_cell_id, band)
