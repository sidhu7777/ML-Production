...
TABLE_NAME = "lte_model1_coverage_prediction_results"
...
CREATE TABLE IF NOT EXISTS {TABLE_NAME} (
    ...
    model_name VARCHAR(100) NOT NULL DEFAULT 'model1_coverage_xgboost',
    ...
    PRIMARY KEY (id),
    UNIQUE KEY uq_model1_project_baseline_run_grid (
        project_id,
        baseline_job_id,
        model_run_id,
        grid_id
    ),
    KEY idx_model1_project_id (project_id),
    KEY idx_model1_project_baseline (project_id, baseline_job_id),
    KEY idx_model1_model_run_id (model_run_id)
