...
def fetch_model2_results(model2_run_id: str, region: str = "india") -> pd.DataFrame:
    query = text(
        """
        SELECT *
        FROM lte_model2_demand_capacity_forecast_results
    ...
    if df.empty:
        raise FileNotFoundError(f"No Model 2 rows found for model_run_id={model2_run_id}")
    return df
        ...
        rows.append(
            {
                ...
                "model_name": "model4_future_capacity_recommendation",
                "model_version": model_version,
                "input_source": "model1_model2_future_forecast",
        ...
        rows.append(
            {
                ...
                "affected_flag": 1,
                "rf_source": "model4_affected_rf_rerun",
