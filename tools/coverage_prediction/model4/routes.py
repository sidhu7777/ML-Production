...
from .services import LTEModel4FutureRecommendationService


lte_model4_future_recommendation_bp = Blueprint("lte_model4_future_recommendation", __name__)
service = LTEModel4FutureRecommendationService()


@lte_model4_future_recommendation_bp.route("/run", methods=["POST"])
...
@lte_model4_future_recommendation_bp.route("/status/<job_id>", methods=["GET"])
...
@lte_model4_future_recommendation_bp.route("/result/<job_id>", methods=["GET"])
